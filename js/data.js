window.TRIP = {
  days: [
    ...
    },
    {
      ...
      restaurants: [
        { name: "豊島美術館カフェ", time: "美術館後", note: "優先順序 1：最順、最不繞，適合帶寶寶休息；只限入館者使用；3～9 月營業 10:00～17:00，L.O.16:30" },
      ...
      alternatives: [
        {
          ...
          timeline: [
            ...
            { time: "13:00～13:40", activity: "豊島美術館カフェ", note: "最穩午餐點心；只限入館者使用；有米粉貝果、棚田 gelato" },
